...
It is important to note that for custom textures to work, convert your PNG or JPEG font to t3x format on Nintendo 3DS. This can be done via [the bundler website](/bundler/overview).
