...
Your game can automatically be fused together _with_ custom metadata using [the bundler](https://bundle.lovebrew.org). This will handle converting any assets for you on Nintendo 3DS as well! You can find more details about this [on its Wiki page](/bundler-app/overview)
